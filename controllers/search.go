...
type SearchIndexRtnJson struct {
	DefaultKeyword     models.MinishopKeywords `json:"defaultKeyword"`
...
func (this *SearchController) Search_Index() {
	o := orm.NewOrm()
	keywordstable := new(models.MinishopKeywords)
	var keyword models.MinishopKeywords
	...
	searchhistorytable := new(models.MinishopSearchHistory)
